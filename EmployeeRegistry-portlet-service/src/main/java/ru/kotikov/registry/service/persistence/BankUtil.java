...
public class BankUtil {
    ...
    * @param bank the bank
    */
    public static void cacheResult(ru.kotikov.registry.model.Bank bank) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.kotikov.registry.model.Bank> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static BankPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (BankPersistence) PortletBeanLocatorUtil.locate(ru.kotikov.registry.service.ClpSerializer.getServletContextName(),
