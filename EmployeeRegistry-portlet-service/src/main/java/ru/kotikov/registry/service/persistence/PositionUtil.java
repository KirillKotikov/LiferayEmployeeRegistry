...
public class PositionUtil {
    ...
    */
    public static ru.kotikov.registry.model.Position[] findByArchiveStatus_PrevAndNext(
        ...
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.kotikov.registry.NoSuchPositionException {
        return getPersistence()
                   .findByArchiveStatus_PrevAndNext(positionId, archiveStatus,
            orderByComparator);
    }
    ...
    */
    public static ru.kotikov.registry.model.Position create(long positionId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.kotikov.registry.model.Position remove(long positionId)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.kotikov.registry.NoSuchPositionException {
