...
import ru.kotikov.registry.model.BankClp;
import ru.kotikov.registry.model.EmployeeClp;
import ru.kotikov.registry.model.PositionClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "EmployeeRegistry-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "EmployeeRegistry-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals("ru.kotikov.registry.model.impl.BankImpl")) {
        ...
        if (oldModelClassName.equals(
                    "ru.kotikov.registry.model.impl.EmployeeImpl")) {
        ...
        if (oldModelClassName.equals(
                    "ru.kotikov.registry.model.impl.PositionImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("ru.kotikov.registry.NoSuchBankException")) {
            return new ru.kotikov.registry.NoSuchBankException();
        }

        if (className.equals("ru.kotikov.registry.NoSuchEmployeeException")) {
            return new ru.kotikov.registry.NoSuchEmployeeException();
        }

        if (className.equals("ru.kotikov.registry.NoSuchPositionException")) {
            return new ru.kotikov.registry.NoSuchPositionException();
        }
