...
import ru.kotikov.registry.NoSuchBankException;
import ru.kotikov.registry.model.Bank;
import ru.kotikov.registry.model.impl.BankImpl;
import ru.kotikov.registry.model.impl.BankModelImpl;
...
public class BankPersistenceImpl extends BasePersistenceImpl<Bank>
    ...
    @Override
    public Bank updateImpl(ru.kotikov.registry.model.Bank bank)
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.ru.kotikov.registry.model.Bank")));
